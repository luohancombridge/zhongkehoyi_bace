...
class run_jie(object):
    def __init__(self):
          ...
          self.data = xlrd.open_workbook(
              r'D:\Users\zhen03.sun\workspace\zhen\test_data\queryPriceDetail\queryPriceDetail.xls')
          self.table = self.data.sheets()[0]
          self.num = self.table.nrows
          self.data = self.table.row_values(self.table.nrows - 1)
          while True:
             self.z = xlrd.open_workbook(r'D:\Users\zhen03.sun\workspace\zhen\test_data\queryPriceDetail\queryPriceDetail.xls')
...
class create_stock(object):
    def __init__(self,h):
        ...
        self.data = xlrd.open_workbook(r'D:\Users\zhen03.sun\workspace\zhen\test_data\queryPriceDetail\queryPriceDetail.xls')
        self.table = self.data.sheets()[0]
    ...
    def creat_json(self):
        ...
        self.j = open(r'D:\Users\zhen03.sun\workspace\zhen\test_data\queryPriceDetail\dd.txt').read()
