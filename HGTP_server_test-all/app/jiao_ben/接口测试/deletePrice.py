...
import unittest
import xlrd
class delete_price(object):
    def __init__(self,h):
        self.h=h
        self.data = xlrd.open_workbook(r'D:\Users\zhen03.sun\workspace\zhen\test_data\deletePriceDetailList\deletePriceDetailList.xls')
